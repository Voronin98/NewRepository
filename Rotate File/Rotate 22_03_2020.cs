...
public class Rotate : MonoBehaviour
{
    ...
    void MercuryModelStart()
    {
        ...
        a_Mercury = 1.00000261f * scaleParameter;
        b_Mercury = a_Mercury * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));

        orbitalPeriod_Mercury = 365.256363004f * 24f * 3600f;
        r_Mercury = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massMercury = 5.9726f * Mathf.Pow(10, 24);

        R_Mercury = (1 - 0.01671123f) * 149597870700f;
        h1_Mercury = -G * (massSun + massMercury);

        a1_Mercury = h1_Mercury / (R_Mercury * Mathf.Pow(30027f, 2));
        ...
        e_Mercury = -2 * Mathf.Pow((vp_Mercury / R_Mercury), 2) * vrSred_Mercury / Mathf.Pow(rSred_Mercury, 3) /*(2 * Mathf.PI) / orbitalPeriod*/;
        ...
        Z1_Mercury = c_Mercury * Mathf.Cos(f_Pluton * Mathf.Pow(10, 8)) * Mathf.Sin(17.14f);
    ...
    {
        //Задаются начальные данные
        a_Venus = 1.00000261f * scaleParameter;
        b_Venus = a_Venus * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));
        c_Venus = 0f;

        orbitalPeriod_Venus = 365.256363004f * 24f * 3600f;
        r_Venus = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massVenus = 5.9726f * Mathf.Pow(10, 24);

        R_Venus = (1 - 0.01671123f) * 149597870700f;
        h1_Venus = -G * (massSun + massVenus);
        a1_Venus = h1_Venus / (R_Venus * Mathf.Pow(30027f, 2));
        ...
        Z1_Venus = c_Venus * Mathf.Cos(f_Venus * Mathf.Pow(10, 6)) * Mathf.Sin(17.14f);
    ...
    {
        //Задаются начальные данные
        a_Mars = 1.00000261f * scaleParameter;
        b_Mars = a * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));
        c_Mars = 0f;

        orbitalPeriod_Mars = 365.256363004f * 24f * 3600f;
        r_Mars = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massMars = 5.9726f * Mathf.Pow(10, 24);

        R_Mars = (1 - 0.01671123f) * 149597870700f;
        h1_Mars = -G * (massSun + massMars);
        a1_Mars = h1_Mars / (R_Mars * Mathf.Pow(30027f, 2));
        ...
        Z1_Mars = c_Mars * Mathf.Cos(f_Mars * Mathf.Pow(10, 8)) * Mathf.Sin(17.14f);
    ...
    {
        //Задаются начальные данные
        a_Jupiter = 1.00000261f * scaleParameter;
        b_Jupiter = a * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));
        c_Jupiter = 0f;

        orbitalPeriod_Jupiter = 365.256363004f * 24f * 3600f;
        r_Jupiter = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massJupiter = 5.9726f * Mathf.Pow(10, 24);

        R_Jupiter = (1 - 0.01671123f) * 149597870700f;
        h1_Jupiter = -G * (massSun + massJupiter);
        a1_Jupiter = h1_Jupiter / (R_Jupiter * Mathf.Pow(30027f, 2));
        ...
        Z1_Jupiter = c_Jupiter * Mathf.Cos(f_Jupiter * Mathf.Pow(10, 8)) * Mathf.Sin(17.14f);
    ...
    {
        //Задаются начальные данные
        a_Saturn = 1.00000261f * scaleParameter;
        b_Saturn = a * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));
        c_Saturn = 0f;

        orbitalPeriod_Saturn = 365.256363004f * 24f * 3600f;
        r_Saturn = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massSaturn = 5.9726f * Mathf.Pow(10, 24);

        R_Saturn = (1 - 0.01671123f) * 149597870700f;
        h1_Saturn = -G * (massSun + massSaturn);
        a1_Saturn = h1_Saturn / (R_Saturn * Mathf.Pow(30027f, 2));
        ...
        Z1_Saturn = c_Saturn * Mathf.Cos(f_Saturn * Mathf.Pow(10, 8)) * Mathf.Sin(17.14f);
    ...
    {
        //Задаются начальные данные
        a_Uranus = 1.00000261f * scaleParameter;
        b_Uranus = a_Uranus * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));
        c_Uranus = 0f;

        orbitalPeriod_Uranus = 365.256363004f * 24f * 3600f;
        r_Uranus = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massUranus = 5.9726f * Mathf.Pow(10, 24);

        R_Uranus = (1 - 0.01671123f) * 149597870700f;
        h1_Uranus = -G * (massSun + massUranus);
        a1_Uranus = h1_Uranus / (R_Uranus * Mathf.Pow(30027f, 2));
        ...
        Z1_Uranus = c_Uranus * Mathf.Cos(f_Uranus * Mathf.Pow(10, 8)) * Mathf.Sin(17.14f);
    ...
    {
        //Задаются начальные данные
        a_Neptune = 1.00000261f * scaleParameter;
        b_Neptune = a_Neptune * Mathf.Sqrt(1 - Mathf.Pow(0.01671123f, 2));
        c_Neptune = 0f;

        orbitalPeriod_Neptune = 365.256363004f * 24f * 3600f;
        r_Neptune = 149598261000f;
        G = 6.67f * Mathf.Pow(10, -11);
        massSun = 1.9885f * Mathf.Pow(10, 30);
        massNeptune = 5.9726f * Mathf.Pow(10, 24);

        R_Neptune = (1 - 0.01671123f) * 149597870700f;
        h1_Neptune = -G * (massSun + massNeptune);
        a1_Neptune = h1_Neptune / (R_Neptune * Mathf.Pow(30027f, 2));
        ...
        Z1_Neptune = c_Neptune * Mathf.Cos(f_Neptune * Mathf.Pow(10, 8)) * Mathf.Sin(17.14f);
    ...
    void PlutoModelStart()
    {
        ...
        a1_Pluton = h1_Pluton / (R_Pluton * Mathf.Pow(5467.55169498f, 2));//Vp = 1726.6724904f - старое значение
